                    ...
                    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                        ...
                        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <nav>
                                <a
                                    href="/genres/create"
                                    class="text-white bg-gradient-to-r from-gold-500 via-gold-600 to-gold-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    Create
                                </a>
                            </nav>
                        </div>
